                ...
                child: Column(
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        color: location ? Colors.grey[200] : Colors.white,
                        child: Padding(
                          ...
                          child: ListTile(
                            leading: Icon(
                              ...
                              color:
                                  location ? Color(0xFFF12412) : Colors.black,
                              size: 25,
                            ),
                            title: Text(
                              ...
                              style: TextStyle(
                                color:
                                    location ? Colors.black : Colors.grey[500],
                              ),
                            ),
                          ),
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        color: restaurant ? Colors.grey[200] : Colors.white,
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: ListTile(
                            leading: Icon(
                              Icons.no_meals,
                              color:
                                  restaurant ? Color(0xFFF12412) : Colors.black,
                              size: 25,
                            ),
                            title: Text(
                              restaurant
                        ...
                        child: Padding(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                color: deals ? Colors.black : Colors.grey[500],
                              ),
                            ),
                          ),
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        color: profile ? Colors.grey[200] : Colors.white,
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: ListTile(
                            leading: Icon(
                            ...
                            // ),
                            title: Text(
                              profile ? 'Profile'.toUpperCase() : 'Profile',
                              style: TextStyle(
                                color:
                                    profile ? Colors.black : Colors.grey[500],
                              ),
                            ),
                          ),
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        color: address ? Colors.grey[200] : Colors.white,
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: ListTile(
                            // leading: Icon(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                color:
                                    address ? Colors.black : Colors.grey[500],
                              ),
                            ),
                          ),
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        color: reviews ? Colors.grey[200] : Colors.white,
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: ListTile(
                            leading: Image.asset(
                              ...
                              height: 25,
                              width: 25,
                              color: reviews ? Color(0xFFF12412) : Colors.black,
                            ),
                            title: Text(
                              reviews ? 'Reviews'.toUpperCase() : "Reviews",
                              style: TextStyle(
                                color:
                                    reviews ? Colors.black : Colors.grey[500],
                              ),
                            ),
                          ),
                        ),
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      leading: Image.asset(
                        ...
                        height: 20,
                        width: 20,
                        color: aboutus ? Color(0xFFF12412) : Colors.black,
                      ),
                      title: Text(
                        aboutus ? 'About Us'.toUpperCase() : "About Us",
                        style: TextStyle(
                          color: aboutus ? Colors.black : Colors.grey[500],
                        ),
                      ),
                    ),
                  ),
